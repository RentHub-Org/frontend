...
export default async function DashBoard(){
    ...
    const rentalFiles = THE_FILES.filter((file: File)=>file.listType == "RENTAL");
    ...
    return (
        <Tabs defaultValue="dev">
            ...
            <TabsContent value="dev"><DevSection files={devFiles}/></TabsContent>
            <TabsContent value="rental"><RentalSection files={rentalFiles}/></TabsContent>
