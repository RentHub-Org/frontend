    ...
    return (
        <div className="px-[40px]">
            <div className="flex justify-between w-full">
                <div className="flex gap-1 items-center text-[#bab9b9]"><IconAsterisk className="text-theme-3" size={10}/><span>Upload/pin files to dev-enviourment</span></div>
                <DevModalButton/>
            </div>
            <div className="mt-2">
                <Table>
...
function FileRow({file, screen}: {file: File, screen: any}){
    ...
    {screen.isLargeScreen && <TableCell>{customTruncate(file.hash)}</TableCell>}
    ...
    <TableCell className="text-right"><a rel="stylesheet"  target="_blank" href={`${process.env.NEXT_PUBLIC_CORE_BASE_URL}/gateway/`+file.hash}>link</a></TableCell>
    </TableRow>
}