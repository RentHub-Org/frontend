...
export default function SignOut() {
    ...
    <BackgroundBeamsWithCollision>
        <h2 className="flex gap-2 flex-col items-center text-2xl relative z-20 md:text-4xl lg:text-7xl font-bold text-center text-white font-sans tracking-tight">
            ...
            <span className="text-sm tracking-tight font-sans flex">You have logged out.<button className="flex gap-1 items-center text-theme-3" onClick={()=>{router.push("/app")}}>Signin here <ExternalLink size={15}/></button></span>
        </h2>
    </BackgroundBeamsWithCollision>
  );
}
